<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('welcome') }}">
            ...
            <span class="ms-1 font-weight-bold">Siap Pensiun</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb2">
                <a class="nav-link {{ Route::currentRouteName() == 'sliders' ? 'active' : '' }}"
                    href="{{ route('sliders') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['sliders']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Slider</span>
                </a>
            </li>
            <li class="nav-item pb2">
                <a class="nav-link {{ Route::currentRouteName() == 'articles' ? 'active' : '' }}"
                    href="{{ route('articles') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['articles']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item pb2">
                <a class="nav-link {{ Route::currentRouteName() == 'teams' ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['teams']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Team</span>
                </a>
            </li>
            <li class="nav-item pb2">
                <a class="nav-link {{ Route::currentRouteName() == 'testimonies' ? 'active' : '' }}"
                    href="{{ route('testimonies') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['testimonies']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
